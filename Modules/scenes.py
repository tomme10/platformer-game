from Modules.scene import scene,levelScene
...
def loadAssets():
    ...
    scenes['Main'] = scene([animation(mainMenuAnimations,100),startbutton(playButton,(400,300),playHover),sound(wind)])
    scenes['Level Select'] = scene([img(levelImg),returnButton(returnArrow,(50,50)),sound(wind)]+buttons)
...
def loadLevel(num,next = True):
    ...
    scenes[f'level{num}'] = levelScene(num,[bg,p,returnButton(returnArrow,(50,50))]+objects,next)
